...
def save_to_yaml(data: str, output_file: str):
    ...
    try:
        ...
        with open(output_file, 'w') as yaml_file:
            yaml.dump(data_dict, yaml_file, default_flow_style=False)  # Write dictionary to YAML file
...
def main():
    ...
    image_path = "op.png"
    output_file = "output.yaml"  # Specify the output YAML file name
    try:
        ...
        save_to_yaml(result, output_file)  # Save the result to a YAML file
    except Exception as e:
